...
get_header(); ?>
    ...
    <aside id="complementary" role="complementary">
      <div id="sidebar-eventmeta" class="sidebar">
        <div class="widget-area">
          <div class="widget">
            ...
            if (!empty($address['address']) && !empty($address['postcode'])) echo '<a href="http://maps.google.com/maps?q='.urlencode($address['address'].' '.$address['postcode']).'"><img class="gmap" src="http://maps.googleapis.com/maps/api/staticmap?maptype=roadmap&zoom=14&size=600x600&markers=color:0xFF0033|'.urlencode($address['address'].' '.$address['postcode']).'&sensor=false"></a>';
